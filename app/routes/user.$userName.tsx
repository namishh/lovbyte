...
import { ArrowRight, Plus, Prohibit } from "phosphor-react";
...
export const loader = async ({
  ...
  return { user: user.user, projects: user.projects }
};
      ...
      <div className="px-0 md:px-4 lg:px-8 md:py-0 py-2 md:w-2/3 w-full lg:w-1/2" style={{ fontFamily: "system-ui, sans-serif", lineHeight: "1.8" }}>
        <div className="flex justify-between flex-wrap gap-4  items-center w-full">
          ...
          <div className="flex gap-3">
            <Link className="text-pink-300 p-3 bg-neutral-900 rounded-xl" to="/"><Plus size={26} /></Link>
            <Link className="text-gray-300 p-3 bg-neutral-900 rounded-xl" to="/"><Prohibit size={26} /></Link>
